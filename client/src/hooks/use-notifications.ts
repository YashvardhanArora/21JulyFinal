      ...
      ws.onmessage = (event) => {
        try {
          ...
          if (data.type === 'new_notification') {
            ...
            try {
              const audio = new Audio('data:audio/wav;base64,');
            } catch (e) {
